...
\runningtitle{Running title may not exceed 60 characters and spaces}
...
\corr{Corresponding author’s name, telephone and fax numbers, and current \email{e-mail} address.}

\keywords{keyword 1, keyword 2, keyword 3, keyword 4, keyword 5, etc..}
